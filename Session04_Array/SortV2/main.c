...
int main(int argc, char *argv[]) {
	...
	// cho thằng nhỏ nhất lên trên cùng của mảng
	if (pos > 0) 	// nếu pos là vị trí đầu mảng thì k cần đổi
					// pos vị trí tìm thấy nhỏ nhất (k tính đầu mảng) 
					// đổi value của [0] với thằng [pos]
	{
		int t = a[0];
		a[0] = a[pos];
		a[pos] = t;
